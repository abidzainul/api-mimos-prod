...
class Visibility extends REST_Controller{
    ...
    {
        parent::__construct();
        $this->load->model('Model_visibility', 'visibility');
    }
    ...
    public function getByDate_get(){
        ...
        $data = $this->visibility->getByDate($userid, $tgl);
    ...
    {
        $data = $this->visibility->getById($id);
    ...
    public function add_post(){
        ...
        $data['visibilitydate'] = $this->post('visibilitydate');
        ...
        //     $exist = $this->visibility->getById($id);
        // }

        // if($exist != null){
        //     // UPDATE
        //     $result = $this->visibility->update($id, $data);
        // }else{
        //     // INSERT
        //     $id = $this->visibility->insert($data);
        //     $result = $this->visibility->getById($id);
        // }

        $exist = $this->visibility->cekIsExist(
            $data['userid'], 
            $data['customerno'], 
            $data['visibilitydate']
        );
        ...
        if($exist != null){
            // UPDATE
            $this->visibility->update($exist->id, $data);
            $result = $this->visibility->getById($exist->id);
        }else{
            // INSERT
            $id = $this->visibility->insert($data);
            $result = $this->visibility->getById($id);
    ...
    public function update_put(){
        ...
        $data['visibilitydate'] = $this->put('visibilitydate');
    ...
    {
        $id = $this->delete('id');
        $data = $this->visibility->delete($id);
    ...
    {
        $id = $this->delete('id');
        $data = $this->visibility->delete_flag($id);
