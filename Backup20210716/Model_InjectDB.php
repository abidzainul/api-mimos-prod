...
{
	public function InjectVisit($userid,$customerno,$visitdate,$notvisitreason,$notbuyreason,$regionid,$salesofficeid,$salesgroupid,$salesdistrictid,$cycle,$week,$year)
	{
        if ($notbuyreason !="-1"){
            $data = array(
              'userid' => $userid,
